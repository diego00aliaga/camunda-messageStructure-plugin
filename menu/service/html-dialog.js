...
const DIALOG_CSS = [
  ...
  '.html-dialog-detail { margin-top: 12px; padding: 12px; background: #f5f5f5; border-radius: 4px; font-size: 13px; color: #666; line-height: 1.6; white-space: pre-wrap; font-family: "Monaco", "Menlo", "Ubuntu Mono", monospace; max-height: 400px; overflow-y: auto; }',
